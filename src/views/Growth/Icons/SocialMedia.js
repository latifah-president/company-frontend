...
<g>
	<g>
		...
		<path className='twitter'  fill='#FFFFFF'  stroke-width='9' d="M119.977,101.828c-0.164-2.297-1.305-4.414-3.141-5.805l-8.328-6.313C106.516,79.625,97.664,72,87.078,72
			...
			C119.305,106.387,120.141,104.129,119.977,101.828z M95.234,107.977c-1.484,1.496-2.313,3.52-2.313"/>
	</g>
</g>
facebook
<g>
	<g>
        {/*twitter box */}
		<path className='svg' fill='#FFFFFF' stroke='#1DA1F2' stroke-width='9' d="M120,40H24C10.766,40,0,50.766,0,64v96c0,13.234,10.766,24,24,24h96c13.234,0,24-10.766,24-24V64
...
<g>
	<g>
        {/*facebook f */}
		<path className='facebook' fill='#FFFFFF'  stroke-width='9'  d="M264,136v-16h-24c-4.422,0-8,3.582-8,8v24h-16v16h16v32h16v-32h16v-16h-16v-16H264z"/>
	</g>
</g>
<g>
	<g>
  ...
  {/*box around facebook */}
		<path className='svg' fill='#FFFFFF' stroke='#4267B2' stroke-width='9'  d="M288,88h-96c-13.234,0-24,10.766-24,24v96c0,13.234,10.766,24,24,24h96c13.234,0,24-10.766,24-24v-96
...
<g>
    ...
    <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="20%" style={{stopColor:'#F58529', stopOpacity:'1'}} />
      <stop offset="40%" style={{stopColor:'#FEDA77', stopOpacity:'1'}} />
          <stop offset="60%" style={{stopColor:'#DD2A7B', stopOpacity:'1'}} />
      <stop offset="80%" style={{stopColor: '#8134AF', stopOpacity:'1'}} />
<stop offset="100%" style={{stopColor:'#515BD4', stopOpacity:'1'}} />


    </linearGradient>
  </defs>
		<path className='svg' fill='#FFFFFF' stroke='url(#grad1)' stroke-width='10' d="M456,0h-96c-13.234,0-24,10.766-24,24v96c0,13.234,10.766,24,24,24h96c13.234,0,24-10.766,24-24V24
